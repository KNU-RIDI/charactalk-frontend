...
<img width="369" height="442" alt="image" src="https://github.com/user-attachments/assets/c6ca0c59-93ed-47f8-8f4c-8e04abffe12d" />
LLM을 활용한 채팅 인터페이스 구현 중, API로부터 전달받는 스트리밍 데이터를 실시간으로 렌더링하는 과정에서 이슈 발생
